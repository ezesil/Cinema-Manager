...
namespace Cinema.UI.Views
{
    ...
    public partial class Home : Form
    {
            ...
            ExceptionHandler exhandler)
        {
            ...
            {
                comboBox1.Items.Add(new ComboBoxItem() { Key = item.Key, Value = item.Value });
            }

            this.comboBox1.Text = _languageService.GetSupportedLanguages()[_languageService.CurrentLanguage] + "-" + _languageService.CurrentLanguage.ToUpper();
        }
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                _languageService.SetLanguage((string)item.Key);
